...
- X（旧Twitter）投稿文3パターン＋ハッシュタグ
- Facebook投稿文＋ハッシュタグ＋1200×630px投稿画像
- Threads投稿文＋ハッシュタグ
- Instagramカルーセル投稿9枚＋キャプション
- Instagramリール動画（1080×1920、ナレーション・BGM付きMP4）
- YouTube動画（1920×1080、ナレーション・BGM付きMP4）
- TikTok動画（1080×1920、ナレーション・BGM付きMP4）
- 投稿文・画像・動画をまとめた一括ZIP
